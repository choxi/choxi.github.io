  ...
  return (
    <Layout>
      <div className="post">
        ...
        <video src="/chinese-landscape.mov" controls></video>
        ...
        <p>
          I built it with <a href="http://p5js.org">p5.js</a> to generate the graphics. The key techniques I used are the procedurally generated buildings and the infinite scrolling effect. Performance can be very slow if objects need to be re-rendered on each frame, so the scrolling effect is done by generating windows of the landscape offscreen and then stitching them together as the scroll moves horizontally. For more detail on the implementation, you can view the relatively short <a href="https://github.com/choxi/generative-experiments">source code here</a>.
        </p>
