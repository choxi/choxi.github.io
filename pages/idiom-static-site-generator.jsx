<PostLayout>
  ...
  <p>
    In contrast, Idiom uses the very fast <a>esbuild</a> to compile your JS and <a>jsdom</a> for prerendering. It also allows you to write your pages as a pure JSX expression without any import boilerplate by autoloading your components assuming certain naming conventions.
  </p>
</PostLayout>