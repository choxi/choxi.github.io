<PostLayout>
  ...
  <div className="post">
    ...
    <p>
      <a href="https://www.gatsbyjs.com">Gatsby</a> is a popular framework for this type of React-based static site. It's powerful but complex, requires a lot of configuration, and can be difficult to debug since it uses a lot of libraries like Webpack and GraphQL in its toolchain. This seems like overkill for a static site generator, I wanted something that:
    </p>
    ...
    <p>
      Idiom is still a work in progress, but if you'd like to try it out or send along any feedback check out the <Link href="https://github.com/choxi/idiomjs">GitHub repo</Link>. This site is also built using Idiom, and you can <a href="https://github.com/choxi.github.io">view the source code here</a>.</p>
  </div>
</PostLayout>